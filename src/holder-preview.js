...
function render() {
  ...
  <section id="community-voting" class="portfolio-block" aria-labelledby="community-voting-title"><div class="portfolio-section-head"><div><span class="micro-label">A SAY IN WHAT COMES NEXT</span><h3 id="community-voting-title">Community voting</h3><p>Which business would you want Mainstreet to fund?</p></div><span class="quiet-pill">Preview ballot</span></div>
