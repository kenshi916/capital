...
export function importPlan(input) {
  if (!input || input.schema !== 'mainstreet-launch-plan' || input.version !== 1 || !input.fields || typeof input.fields !== 'object' || Array.isArray(input.fields)) throw new Error('Choose a Mainstreet launch plan JSON file (version 1).');
